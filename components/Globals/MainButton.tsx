...
const MainButton = (props: MainButtonProps) => {
  ...
  const buttonColors = () => {
    ...
    if (type === "secondary-outlined") {
      return { background: "transparent", border: Colors.theme.secondary };
    }
    if (type === "primary-orange") {
      return {
        background: Colors.theme.primaryOrange,
        border: Colors.theme.secondary,
      };
    }
    if (type === "primary-orange-outlined") {
      return {
        background: "transparent",
        border: Colors.theme.primaryOrange,
      };
    }
    if (type === "secondary") {
      return { background: Colors.theme.secondary, border: "transparent" };
    }
  ...
  return (
    <AnimatedBox
      ...
      radius={radius}
      color={disabled ? Colors.theme.disabled : buttonColors()?.background}
...
export const MainButtonUnanimated = (props: MainButtonProps) => {
  const {
    color,
    icon,
    labelProps,
    ...
    >
      {children ? (
        ...
        >
          ...
          {loading === false && (
            <>
              {icon && icon.position !== "append" && <ButtonIcon icon={icon} />}
              <MainText
                color={labelColor()}
                size={size}
                fontWeight="semibold"
